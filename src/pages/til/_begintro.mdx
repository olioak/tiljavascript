...
- show difference between console and writing on file (use new Date()) LATER
- depending on the browser, you may or may not see the quotes on the console
- say that in some browsers you can't copy paste to the console.
